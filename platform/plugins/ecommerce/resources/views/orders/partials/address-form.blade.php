        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-12">
                <div class="form-group mb-3 @if ($errors->has('address.state')) has-error @endif">
                    <select id="address_state" type="text" class="form-control address-control-item address-control-item-required checkout-input" placeholder="{{ __('State') }}" name="address[state]">
            ...
            <div class="col-sm-6 col-12">
                <div class="form-group  @if ($errors->has('address.city')) has-error @endif">
                    <select id="address_city" type="text" class="form-control address-control-item address-control-item-required checkout-input" placeholder="{{ __('City') }}" name="address[city]">
                        <option>---city---</option>
